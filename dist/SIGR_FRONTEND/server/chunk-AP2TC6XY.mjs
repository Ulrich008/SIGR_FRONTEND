...
function SidebarComponent_li_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function SidebarComponent_li_10_Template_button_click_1_listener() {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275classProp("bg-green-700", ctx_r2.activeMenu === item_r2.label)("text-white", ctx_r2.activeMenu === item_r2.label)("font-medium", ctx_r2.activeMenu === item_r2.label);
    \u0275\u0275advance();
...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], inputs: { menuItems: "menuItems", activeMenu: "activeMenu" }, outputs: { menuItemClicked: "menuItemClicked" }, decls: 19, vars: 1, consts: [[1, "w-64", "lg:w-72", "xl:w-80", "min-h-screen", "bg-white", "flex", "flex-col", "shadow-sm", "flex-shrink-0"], [1, "px-6", "pt-8", "pb-6", "border-b", "border-gray-100", "flex", "flex-col", "items-center"], [1, "text-2xl", "font-bold", "text-center", 2, "color", "#1a4731"], [1, "text-xs", "text-gray-400", "mt-1", "text-center"], [1, "flex-1", "px-4", "py-6"], [1, "text-xs", "font-semibold", "text-gray-400", "uppercase", "tracking-wider", "mb-4", "px-3"], [1, "space-y-1.5"], [4, "ngFor", "ngForOf"], [1, "m-4", "rounded-xl", "p-4", "flex", "items-center", "gap-3", 2, "background", "#1a5c38"], [1, "w-10", "h-10", "rounded-xl", "bg-green-600", "flex", "items-center", "justify-center", "text-white", "text-sm", "font-bold", "flex-shrink-0"], [1, "text-white", "text-sm", "font-semibold", "leading-tight"], [1, "text-green-300", "text-xs", "leading-tight", "mt-0.5"], [1, "w-full", "flex", "items-center", "gap-3", "px-4", "py-2.5", "rounded-xl", "text-sm", "transition-all", "text-left", "text-gray-600", "hover:bg-green-50", "hover:text-green-800", 3, "click"], [1, "w-5", "h-5", "flex-shrink-0"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "aside", 0)(1, "div", 1)(2, "p", 2);
      \u0275\u0275text(3, "SIGR");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 3);
      \u0275\u0275text(5, "Gestion des Risques");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "nav", 4)(7, "p", 5);
      \u0275\u0275text(8, "Menu principal");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "ul", 6);
      \u0275\u0275template(10, SidebarComponent_li_10_Template, 4, 9, "li", 7);
      \u0275\u0275elementEnd()();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-sidebar", imports: [CommonModule, RouterModule], template: '<!-- SIDEBAR - Agrandie -->\n<aside class="w-64 lg:w-72 xl:w-80 min-h-screen bg-white flex flex-col shadow-sm flex-shrink-0">\n  <!-- Logo + SIGR - Centr\xE9 -->\n  <div class="px-6 pt-8 pb-6 border-b border-gray-100 flex flex-col items-center">\n    <p class="text-2xl font-bold text-center" style="color: #1a4731;">SIGR</p>\n    <p class="text-xs text-gray-400 mt-1 text-center">Gestion des Risques</p>\n  </div>\n\n  <!-- Nav - Espacement am\xE9lior\xE9 -->\n  <nav class="flex-1 px-4 py-6">\n    <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-4 px-3">Menu principal</p>\n    <ul class="space-y-1.5">\n      <li *ngFor="let item of menuItems">\n        <button\n          (click)="onMenuItemClick(item)"\n          [class.bg-green-700]="activeMenu === item.label"\n          [class.text-white]="activeMenu === item.label"\n          [class.font-medium]="activeMenu === item.label"\n          class="w-full flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm transition-all text-left text-gray-600 hover:bg-green-50 hover:text-green-800"\n        >\n          <i [class]="item.icon" class="w-5 h-5 flex-shrink-0"></i>\n          {{ item.label }}\n        </button>\n      </li>\n    </ul>\n  </nav>\n\n  <!-- Admin footer - Am\xE9lior\xE9 -->\n  <div class="m-4 rounded-xl p-4 flex items-center gap-3" style="background: #1a5c38">\n    <div class="w-10 h-10 rounded-xl bg-green-600 flex items-center justify-center text-white text-sm font-bold flex-shrink-0">\n      AD\n    </div>\n    <div>\n      <p class="text-white text-sm font-semibold leading-tight">Admin MEF</p>\n      <p class="text-green-300 text-xs leading-tight mt-0.5">Administrateur</p>\n    </div>\n  </div>\n</aside>' }]
  }], () => [{ type: Router }], { menuItems: [{
    type: Input
  }], activeMenu: [{
    type: Input
  }], menuItemClicked: [{
...
var HeaderComponent = class _HeaderComponent {
  ...
  confirmLogout() {
    Swal.fire({
      ...
      text: "Vous serez redirig\xE9 vers la page de connexion.",
      icon: "warning",
      showCancelButton: true,
      confirmButtonText: "Oui, d\xE9connexion",
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          title: "D\xE9connect\xE9",
          text: "Vous avez \xE9t\xE9 d\xE9connect\xE9 avec succ\xE8s.",
          icon: "success",
          timer: 1500,
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], inputs: { searchPlaceholder: "searchPlaceholder", organizationName: "organizationName", userInitials: "userInitials" }, decls: 13, vars: 3, consts: [[1, "bg-white", "border-b", "border-gray-100", "px-6", "py-3", "flex", "items-center", "justify-between", "flex-shrink-0"], [1, "relative"], [1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "w-4", "h-4", "text-gray-400"], ["type", "text", 1, "pl-9", "pr-4", "py-2", "bg-gray-50", "border", "border-gray-200", "rounded-lg", "text-sm", "text-gray-600", "w-80", "lg:w-96", "focus:outline-none", "focus:border-green-400", "placeholder-gray-400", 2, "font-family", "'Inter', system-ui, sans-serif", 3, "placeholder"], [1, "flex", "items-center", "gap-3"], [1, "text-sm", "text-gray-500"], ["type", "button", 1, "inline-flex", "items-center", "gap-2", "rounded-full", "border", "border-slate-200", "bg-white", "px-4", "py-2", "text-sm", "font-semibold", "text-slate-700", "transition", "hover:bg-slate-50", 3, "click"], [1, "w-8", "h-8", "rounded-full", "bg-green-700", "flex", "items-center", "justify-center", "text-white", "text-xs", "font-bold"]], template: function HeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275domElementStart(0, "div", 0)(1, "div", 1)(2, "i", 2);
      \u0275\u0275text(3, "\u{1F50D}");
      \u0275\u0275domElementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HeaderComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-header", imports: [CommonModule], template: `<!-- Top bar -->
<div class="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between flex-shrink-0">
  <div class="relative">
    <i class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400">\u{1F50D}</i>
    <input
      type="text"
      [placeholder]="searchPlaceholder"
      class="pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 w-80 lg:w-96 focus:outline-none focus:border-green-400 placeholder-gray-400"
  ...
  }], () => [{ type: AuthService }, { type: Router }], { searchPlaceholder: [{
    type: Input
  }], organizationName: [{
    type: Input
  }], userInitials: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HeaderComponent, { className: "HeaderComponent", filePath: "src/app/layout/header/header.component.ts", lineNumber: 13 });
})();
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], inputs: { menuItems: "menuItems", activeMenu: "activeMenu", searchPlaceholder: "searchPlaceholder", organizationName: "organizationName", userInitials: "userInitials" }, ngContentSelectors: _c0, decls: 6, vars: 5, consts: [[1, "flex", "min-h-screen", 2, "background", "#fef2f2", "font-family", "'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"], [3, "menuItemClicked", "menuItems", "activeMenu"], [1, "flex-1", "flex", "flex-col", "overflow-hidden", "min-w-0"], [3, "searchPlaceholder", "organizationName", "userInitials"], [1, "flex-1", "overflow-y-auto"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
      \u0275\u0275elementStart(0, "div", 0)(1, "app-sidebar", 1);
      \u0275\u0275listener("menuItemClicked", function MainLayoutComponent_Template_app_sidebar_menuItemClicked_1_listener($event) {
        return ctx.onMenuItemClicked($event);
      });
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("searchPlaceholder", ctx.searchPlaceholder)("organizationName", ctx.organizationName)("userInitials", ctx.userInitials);
    }
  }, dependencies: [CommonModule, SidebarComponent, HeaderComponent], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MainLayoutComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-main-layout", imports: [CommonModule, SidebarComponent, HeaderComponent], template: `<div class="flex min-h-screen" style="background: #fef2f2; font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayoutComponent, { className: "MainLayoutComponent", filePath: "src/app/layout/main-layout/main-layout.component.ts", lineNumber: 12 });
})();
...
//# sourceMappingURL=chunk-AP2TC6XY.mjs.map
