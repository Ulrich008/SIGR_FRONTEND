...
var HeaderComponent = class _HeaderComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HeaderComponent, selectors: [["app-header"]], inputs: { searchPlaceholder: "searchPlaceholder", organizationName: "organizationName", userInitials: "userInitials" }, decls: 13, vars: 3, consts: [[1, "bg-white", "border-b", "border-gray-100", "px-6", "py-3", "flex", "items-center", "justify-between", "flex-shrink-0"], [1, "relative"], [1, "absolute", "left-3", "top-1/2", "-translate-y-1/2", "w-4", "h-4", "text-gray-400"], ["type", "text", 1, "pl-9", "pr-4", "py-2", "bg-gray-50", "border", "border-gray-200", "rounded-lg", "text-sm", "text-gray-600", "w-80", "focus:outline-none", "focus:border-green-400", "placeholder-gray-400", 2, "font-family", "'Inter', system-ui, sans-serif", 3, "placeholder"], [1, "flex", "items-center", "gap-3"], [1, "text-sm", "text-gray-500"], ["type", "button", 1, "inline-flex", "items-center", "gap-2", "rounded-full", "border", "border-slate-200", "bg-white", "px-4", "py-2", "text-sm", "font-semibold", "text-slate-700", "transition", "hover:bg-slate-50", 3, "click"], [1, "w-8", "h-8", "rounded-full", "bg-green-700", "flex", "items-center", "justify-center", "text-white", "text-xs", "font-bold"]], template: function HeaderComponent_Template(rf, ctx) {
    if (rf & 1) {
...
<div class="bg-white border-b border-gray-100 px-6 py-3 flex items-center justify-between flex-shrink-0">
  <div class="relative">
    ...
    <input
      ...
      class="pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-sm text-gray-600 w-80 focus:outline-none focus:border-green-400 placeholder-gray-400"
...
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], inputs: { menuItems: "menuItems", activeMenu: "activeMenu", searchPlaceholder: "searchPlaceholder", organizationName: "organizationName", userInitials: "userInitials" }, ngContentSelectors: _c0, decls: 6, vars: 5, consts: [[1, "flex", "h-screen", 2, "background", "#fef2f2", "font-family", "'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif"], [3, "menuItemClicked", "menuItems", "activeMenu"], [1, "flex-1", "flex", "flex-col", "overflow-hidden"], [3, "searchPlaceholder", "organizationName", "userInitials"], [1, "flex-1", "overflow-y-auto"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275projectionDef();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MainLayoutComponent, [{
    type: Component,
    args: [{ standalone: true, selector: "app-main-layout", imports: [CommonModule, SidebarComponent, HeaderComponent], template: `<div class="flex h-screen" style="background: #fef2f2; font-family: 'Inter', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
...
//# sourceMappingURL=chunk-6FME2CHX.mjs.map
